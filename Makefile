...
install:
	chef exec gem build kitchen-provisioner-chef-ice.gemspec
	chef exec gem install kitchen-provisioner-chef-ice-*.gem
	rm -f kitchen-provisioner-chef-ice-*.gem
...
clean:
	rm -rf pkg/ tmp/ coverage/ kitchen-provisioner-chef-ice-*.gem
